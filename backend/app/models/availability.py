...
from sqlalchemy import Date, DateTime, ForeignKey, UniqueConstraint, Enum as SAEnum
...
class DayAvailability(Base):
    ...
    __table_args__ = (
        UniqueConstraint("circle_id", "user_id", "local_date", name="uq_circle_user_date"),
    )
    ...
    circle: Mapped["Circle"] = relationship("Circle", back_populates="availabilities")
